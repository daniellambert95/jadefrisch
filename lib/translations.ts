export const t = {
  en: {
    ...
    hero: {
      ...
      name: "Jade Frisch",
      tagline: "German–English Translator",
      bio: "A native English speaker and linguist with over ten years of experience translating and localising German technical, IT and marketing content.",
      cta1: "Get in touch",
      cta2: "View services",
      scroll: "Scroll",
    },
    ...
    // Footer
    footer: {
      copyright: "© 2026 Jade Frisch",
      webdesign: "Webdesign by Site&Sight",
    },
    ...
    contact: {
      ...
      heading: "Let's work\ntogether.",
      intro: "Whether you have a project in mind or simply want to discuss your needs, I'm happy to hear from you.",
      labelName: "Name",
      labelEmail: "Email",
      ...
      sending: "Sending…",
      thankYou: "Thank you.",
      inTouch: "I'll be in touch shortly.",
    },
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "I loved to work with Jade. Her ability to keep the best attitude even when the going gets tough, flexibility and great translation skills guarantee that the work will be well done.",
          author: "DuxTranslations",
        },
        {
          quote: "Jade has done consistently high-quality work, on-time and according to project guidelines.",
    ...
    home: {
      ...
      faqTeaser: {
        ...
        intro: "Everything you need to know before getting in touch.",
    ...
    servicesPage: {
      ...
      items: [
        ...
        },
        {
          num: "02",
          title: "Marketing Translation & Transcreation",
          description: "Translation, transcreation, SEO and localisation for campaigns, product pages, social media and more. Your brand voice, preserved and adapted for English-speaking audiences.",
          linkLabel: "Explore",
        },
        {
          num: "03",
    ...
    // Technical translation page
    technicalPage: {
      breadcrumbServices: "Services",
      breadcrumbCurrent: "Technical Translation",
      ...
      ctaText: "Ready to discuss your technical translation project?",
    },

    // Marketing translation page
    marketingPage: {
      breadcrumbServices: "Services",
      breadcrumbCurrent: "Marketing Translation",
  ...
  de: {
    ...
    hero: {
      ...
      name: "Jade Frisch",
      tagline: "Deutsch–Englische Übersetzerin",
      bio: "Englische Muttersprachlerin und Sprachwissenschaftlerin mit über zehn Jahren Erfahrung in der Übersetzung und Lokalisierung deutschsprachiger Fach-, IT- und Marketingtexte.",
      ...
      items: [
        {
          ...
          description: "Präzise DE↔EN-Übersetzung von Handbüchern, Spezifikationen, Datenblättern, Softwaredokumentation und technischen Inhalten. Spezialisiert auf IT, Automotive und industrielle Fertigung.",
    ...
    contact: {
      overline: "Kontakt",
      heading: "Lassen Sie uns\nzusammenarbeiten.",
      intro: "Ob Sie ein konkretes Projekt haben oder einfach Ihre Anforderungen besprechen möchten — ich freue mich von Ihnen zu hören.",
      labelName: "Name",
      labelEmail: "E-Mail",
      labelMessage: "Nachricht",
      placeholderName: "Ihr Name",
      placeholderEmail: "ihre@email.de",
      placeholderMessage: "Erzählen Sie mir von Ihrem Projekt...",
      submit: "Nachricht senden",
      sending: "Wird gesendet…",
      thankYou: "Vielen Dank.",
      inTouch: "Ich melde mich in Kürze bei Ihnen.",
    },
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "Ich habe sehr gerne mit Jade zusammengearbeitet. Ihre Fähigkeit, auch in schwierigen Situationen eine positive Einstellung zu bewahren, ihre Flexibilität und ihre hervorragenden Übersetzungsfähigkeiten garantieren, dass die Arbeit stets gut erledigt wird.",
          author: "DuxTranslations",
        },
        {
          quote: "Jade liefert durchgehend qualitativ hochwertige Arbeit — pünktlich und gemäß den Projektrichtlinien.",
          author: "TBO IntoEnglish",
        },
      ],
    },
    ...
    qualifications: {
      ...
      items: [
        ...
        },
        {
          ...
          subtitle: "Freie Universität Berlin",
          detail: "Studium von Französisch und Spanisch neben Deutschlinguistik, mit einem Auslandssemester an der Universitat de València.",
        },
        {
          title: "BDÜ-Mitglied",
          subtitle: "Bundesverband für Dolmetschen und Übersetzen",
    ...
    home: {
      ...
      faqTeaser: {
        overline: "Fragen & Antworten",
        heading: "Häufige Fragen",
        intro: "Alles, was Sie vor einer Kontaktaufnahme wissen möchten.",
        ...
        items: [
          ...
          {
            q: "Warum mit einem freiberuflichen Sprachprofi zusammenarbeiten?",
            a: "Die Zusammenarbeit bedeutet direkte Kommunikation ohne Umwege. Ihre Dokumente werden immer von mir übersetzt, was konsistente Terminologie, Stil und Ton gewährleistet.",
          },
        ],
      },
    },
    ...
    // Services page
    servicesPage: {
      overline: "Sprachdienstleistungen",
      title: "Leistungen",
      subtitle: "Fach- und Marketingübersetzungen DE↔EN und mehr.",
      readyText: "Bereit, Ihr Projekt zu besprechen?",
    ...
    faqPage: {
      overline: "Fragen & Antworten",
      title: "FAQ",
      subtitle: "Alles, was Sie vor einer Kontaktaufnahme wissen möchten.",
    ...
    contactPage: {
      ...
      subtitle: "Ich bespreche gerne Ihr Projekt — unverbindlich.",
    },

    // Technical translation page
    technicalPage: {
      breadcrumbServices: "Leistungen",
      breadcrumbCurrent: "Fachübersetzung",
      overline: "Fachübersetzung",
      title: "Präzision in jedem Wort.",
      subtitle: "Von Handbüchern bis zur Softwaredokumentation — Genauigkeit ist unverhandelbar.",
      intro1: "Fachübersetzung erfordert höchste Präzision, Genauigkeit und Konsistenz. Dafür brauchen Sie eine erfahrene und qualifizierte Fachkraft, die weiß, wie Ihr Produkt funktioniert.",
      intro2: "Ob die Feinheiten kleinster Bauteile, die Wasserhähne zum Laufen bringen, oder die intelligente Software, die beim Einparken hilft: Ich verstehe diese Welt und tauche mit Begeisterung in sie ein.",
      fieldsOverline: "Spezialisierungen",
      fieldsHeading: "Fachgebiete",
      fields: ["Automotive", "IT", "Maschinenbau", "Bau und Sanitär"],
      ...
      documents: [
        "Benutzerhandbücher",
        "Hilfe- und Fehlerbehebungsdokumente",
        "Betriebs- und Wartungshandbücher",
        "Knowledge-Base-Artikel",
        "Softwareoberflächen",
        "Produktanforderungsspezifikationen",
        "Technische Datenblätter",
        "Installationshandbücher",
        "Sicherheitsdokumentation und Compliance-Unterlagen",
      ],
      andMore: "und mehr",
      ...
      ctaText: "Bereit, Ihr Fachübersetzungsprojekt zu besprechen?",
    },

    // Marketing translation page
    marketingPage: {
      breadcrumbServices: "Leistungen",
      breadcrumbCurrent: "Marketingübersetzung",
